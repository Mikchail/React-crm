            ...
            <div>
                ...
                <form onSubmit={formik.handleSubmit} >
                    <div className="input-field">
                        <select value={formik.values.category} onChange={formik.handleChange("category")}>
                    ...
                    <div className="input-field">
                        <input type="text" id="name" value={formik.values.name} onChange={formik.handleChange("name")} />
